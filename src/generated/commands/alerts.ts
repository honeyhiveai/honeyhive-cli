...
export function alertsCommand(): Command {
  ...
  cmd
    ...
    .option(
      '--project-id <value>',
      'The unique identifier of the project whose alerts are listed (required)',
    )
    .option('--page <value>', '1-indexed page number')
    .option('--limit <value>', 'Number of alerts to return per page')
    .addOption(
      new Option('--status <value>', 'Only return alerts in this status').choices([
        'ACTIVE',
        'TRIGGERED',
        'PAUSED',
        'RESOLVED',
    ...
    .addOption(
      new Option('--sort-by <value>', 'Field to sort results by').choices([
        'created_at',
        'updated_at',
        'name',
        'status',
  ...
  cmd
    ...
    .option(
      '--project-id <value>',
      'The unique identifier of the project the alert is created in (required)',
    )
    .option('--name <value>', 'name (required)')
    .addOption(
      new Option('--frequency <value>', 'frequency (required)').choices([
        'HOURLY',
        'DAILY',
        'WEEKLY',
        'MONTHLY',
    ...
    .addOption(
      new Option('--alert-type <value>', 'alert_type').choices(['DRIFT', 'AGGREGATE', 'PER_EVENT']),
    )
    .addOption(
      new Option('--aggregation <value>', 'aggregation').choices([
        'AVERAGE',
        'COUNT',
        'SUM',
        'MIN',
  ...
  cmd
    ...
    .option(
      '--project-id <value>',
      'The unique identifier of the project the alert belongs to (required)',
    )
